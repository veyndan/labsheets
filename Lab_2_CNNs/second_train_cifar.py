...
tf.app.flags.DEFINE_string('log-dir', '{cwd}/logs_second/'.format(cwd=os.getcwd()), 'Directory where to write event logs and checkpoint. (default: %(default)s)')
...
def deepnn(x):
    ...
    with tf.variable_scope('Out'):
        ...
        y_conv = tf.matmul(h_fc1, W_out) + b_out
